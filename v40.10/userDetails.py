...
@app.route('/create_user/<name>,<CompanyNotInterest>,<type_>,<stage>,<company>,<my_email>,<retype_email>,<password>,<education>,<from_>,<in_>,<CandidateStatus>,<My_Expected_compensation_active>,<My_Expected_compensation_passive>,<Your_Linkedin_Profile>,<Your_Linkedin_ProfileActive>,<github_passive>,<github_active>,<My_expertise_lies_in>,<My_Core_competencies>,<My_Core_competenciesActive>,<My_Work_Experience>,<My_Mobile_number>,<My_Current_Employer>,<Im_available_in>', methods=['GET', 'POST'])
def create_user(name, CompanyNotInterest, type_, stage, company, my_email, retype_email, password, education, from_, in_, CandidateStatus, My_Expected_compensation_active, My_Expected_compensation_passive, Your_Linkedin_Profile, Your_Linkedin_ProfileActive, github_passive, github_active,My_expertise_lies_in, My_Core_competencies, My_Core_competenciesActive, My_Work_Experience, My_Mobile_number, My_Current_Employer, Im_available_in):
  ...
  if request.method == 'POST':
    ...
    CompanyNotInterest = request.form['CompanyNotInterest']

    My_Expected_compensation = request.form['My_Expected_compensation_active'] or request.form['My_Expected_compensation_passive'] 

    Your_Linkedin_Profile = request.form['Your_Linkedin_Profile'] or request.form['Your_Linkedin_ProfileActive']
    github = request.form['github_active'] or request.form['github_passive']
    ...
    hashEmail = hash(my_email)
    verification = "No"
    print(hashEmail)

    mycursor = mydb.cursor()
    sql = queries.CREATE_USER
    val = (name, type_, stage, company, my_email, retype_email, education, from_, in_, CandidateStatus, CompanyNotInterest, My_Expected_compensation, Your_Linkedin_Profile, github,My_expertise_lies_in, My_Core_competencies, My_Work_Experience,My_Mobile_number, My_Current_Employer, Im_available_in)
    mycursor.execute(sql, val)
    mydb.commit()

    mycursor = mydb.cursor()
    sql = queries.USER_CREDENTIAL
    val = (my_email, password, verification, hashEmail)
    mycursor.execute(sql, val)
    mydb.commit()
    ...
    usrDetails (name, type_, stage, company, my_email, retype_email, education, from_, in_,CandidateStatus, CompanyNotInterest, My_Expected_compensation, Your_Linkedin_Profile, github,My_expertise_lies_in, My_Core_competencies, My_Work_Experience,My_Mobile_number, My_Current_Employer, Im_available_in)
...
def usrDetails (name, type_, stage, company, my_email, retype_email, education, from_, in_,CandidateStatus, CompanyNotInterest, My_Expected_compensation, Your_Linkedin_Profile, github,My_expertise_lies_in, My_Core_competencies, My_Work_Experience,My_Mobile_number, My_Current_Employer, Im_available_in):
  global name1, type_1, stage1, company1, my_email1, retype_email1, education1, from_1, in_1,CandidateStatus1, CompanyNotInterest1, My_Expected_compensation1, Your_Linkedin_Profile1, github1, My_expertise_lies_in1, My_Core_competencies1, My_Work_Experience1, My_Mobile_number1, My_Current_Employer1, Im_available_in1
  name1 = name
  type_1 = type_
  stage1 = stage
  company1 = company
  ...
  CompanyNotInterest1 = CompanyNotInterest
...
def candidate():
  ...
  company = company1
  candidate_email = my_email1

  mycursor = mydb.cursor()
  sql = queries.ACCEPTANCE
  val = (candidate_email, company )
  mycursor.execute(sql, val)
  mydb.commit()
