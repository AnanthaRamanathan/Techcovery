...
def recruterSignUpPage():
  ...
  cursor = mydb.cursor()
  sql = RecruiterSignUpCompany.COMPANY_DETAILS_test
  cursor.execute(sql, )
  dataList = cursor.fetchall()
  print (dataList)

  cursor = mydb.cursor()
  sql = RecruiterSignUpCompany.COMPANY_DETAILS_test2
  cursor.execute(sql, )
  ...
  return render_template('recruterSignUp.html', dataList=json.dumps(dataList), dataList2=json.dumps(dataList2))
